...
//bottom motor
#define STEP_PIN2 GPIO_PIN_12
#define DIR_PIN2 GPIO_PIN_14
#define STEP_PORT GPIOB
//int stepDelay = 500; // 500us more delay means less speed
...
void moveMotor1(int steps, int dir, int stepDelay) {
...
void moveMotor2(int steps, int dir, int stepDelay) {
	HAL_GPIO_WritePin(DIR_PORT, DIR_PIN2, dir);
	for (int x = 0; x < steps; x++) {
		HAL_GPIO_WritePin(STEP_PORT, STEP_PIN2, GPIO_PIN_SET);
		microDelay(stepDelay);
		HAL_GPIO_WritePin(STEP_PORT, STEP_PIN2, GPIO_PIN_RESET);
...
int main(void)
{
  ...
  while (1)
  {
	  //motor 1
	           ...
	           //HAL_GPIO_WritePin(DIR_PORT, DIR_PIN2, GPIO_PIN_SET);
	           //first motor
			  moveMotor1(8000, 0, 1200); //top motor dir = 0 is forwards
	           //moveMotor1Forward();
	           ...
	           //second motor
			  moveMotor2(7980, 1, 1200); //bottom motor: 1 is backwards
	           //moveMotor2Forward();
	           /*
